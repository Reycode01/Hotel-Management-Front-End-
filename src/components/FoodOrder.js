...
const FoodOrder = ({ onAddFoodOrder }) => {
  ...
  useEffect(() => {
    const fetchFoodOrders = async () => {
      try {
        const response = await axios.get('https://hotel-management-backend-3.onrender.com/api/food-orders');
  ...
  const handleAddFoodOrder = async () => {
    ...
    try {
      const response = await axios.post('https://hotel-management-backend-3.onrender.com/api/food-orders', newFoodOrder);
  ...
  const handleDeleteFoodOrder = async (id) => {
    try {
      const response = await axios.delete(`https://hotel-management-backend-3.onrender.com/api/food-orders/${id}`);
